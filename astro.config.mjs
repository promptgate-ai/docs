			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Agent Proxy', slug: 'concepts/agent-proxy' },
					],
				},
				{
				...
				},
				{
					...
					items: [
						...
						{ label: 'Reversible Redaction', slug: 'security/reversible-redaction' },
						{ label: 'Secret Scanner', slug: 'security/secret-scanner' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'Claude Code through PromptGate', slug: 'cookbook/claude-code-through-promptgate' },
						{ label: 'Codex CLI through PromptGate', slug: 'cookbook/codex-cli-through-promptgate' },
					],
				},
			],
		}),
